<%@ Page Title="حساب کاربری" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Team10BookShop.Account.Manage" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row text-center justify-content-center">
        ...
        <div id="MsgNoOrder" runat="server" class="col-12">
            <br />
            <br />
            <br />
            <br />
            <span class="alert alert-warning h5">شما هنوز هیچ سفارشی ثبت نکردید لطفا برای ثبت سفارش از صفحه اصلی کتاب های مورد نظر خود را انتخاب کنید</span>
            <br />
            <br />
            <br />
            <br />
